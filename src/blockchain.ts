import { ChainId, Currency, ETHER, BINANCE_COIN, MATIC_TOKEN } from '@rcpswap/sdk'
    ...
    if (blockchain) {
      ...
      switch (this.chainId) {
        ...
        case 137:
          ...
          break
        case 42170:
          this.blockchain = Blockchain.ARBITRUM_NOVA
          break
        default:
    ...
    if (rpcURLs && rpcURLs.length > 0) {
      ...
      switch (this.chainId) {
        ...
        case 137:
          ...
          break
        case 42170:
          this.rpcURLs = ['https://nova.arbitrum.io/rpc/', 'https://arbitrum-nova.public.blastapi.io/']
          break
        case 1666700000:
    ...
    if (explorerURL && explorerURL !== '') {
      ...
      switch (this.chainId) {
        ...
        case 137:
          ...
          break
        case 42170:
          this.explorerURL = 'https://nova.arbiscan.io/'
          break
        case 1666700000:
...
export const BLOCKCHAIN_SETTINGS: { [chainId in ChainId]: BlockchainSettings } = {
  ...
  [ChainId.POLYGON]: new BlockchainSettings(ChainId.POLYGON),
